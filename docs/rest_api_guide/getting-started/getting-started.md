...
description: Steps to make an initial StorageSphere Enterprise 3.0 API request.
sidebar_position: 2
---
...
This topic describes how to make an initial StorageSphere Enterprise 3.0 REST API request. Use this workflow to verify connectivity, authentication, authorization, and response handling before building a larger integration.
