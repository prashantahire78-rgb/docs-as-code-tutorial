...
id: authorization
title: Authorization
description: Overview of REST API authorization for StorageSphere Enterprise 2.0.
sidebar_position: 4
---
...
StorageSphere Enterprise 2.0 uses Role-Based Access Control (RBAC) to authorize REST API requests. After authentication succeeds, StorageSphere Enterprise evaluates the caller's role and permissions before allowing access to a resource or action.
