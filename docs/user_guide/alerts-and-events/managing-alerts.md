...
description: Steps to review and manage alerts in StorageSphere Enterprise 3.0.
sidebar_position: 1
---
...
This topic describes how to manage alerts in StorageSphere Enterprise 3.0. Alerts identify conditions that require review, acknowledgement, escalation, or remediation.
