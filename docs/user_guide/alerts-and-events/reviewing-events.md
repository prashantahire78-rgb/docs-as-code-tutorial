...
description: Steps to review events in StorageSphere Enterprise 2.0.
sidebar_position: 3
---
...
This topic describes how to review events in StorageSphere Enterprise 2.0. Events record operational activity, configuration changes, discovery job results, alert state changes, authentication activity, and system health updates.
