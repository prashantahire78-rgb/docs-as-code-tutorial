...
description: Steps to view audit logs in StorageSphere Enterprise 2.0.
sidebar_position: 2
---
...
This topic describes how to view audit logs in StorageSphere Enterprise 2.0. Audit logs record administrative, security, authentication, report, and API activities for accountability and compliance review.
