...
description: Steps to view storage inventory in StorageSphere Enterprise 2.0.
sidebar_position: 1
---
...
This topic describes how to view storage inventory in StorageSphere Enterprise 2.0. Inventory views show discovered storage systems, pools, volumes, hosts, ports, and relationships across supported storage platforms.
