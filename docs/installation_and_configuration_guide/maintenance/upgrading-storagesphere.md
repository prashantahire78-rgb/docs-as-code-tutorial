...
description: Steps to upgrade StorageSphere Enterprise 2.0 components.
sidebar_position: 5
---
...
This topic describes how to upgrade StorageSphere Enterprise 2.0. An upgrade updates the management server, database schema, collectors, and related services to a newer supported maintenance or feature release.
