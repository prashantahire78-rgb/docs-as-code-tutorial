...
description: Steps to uninstall StorageSphere Enterprise 2.0 components.
sidebar_position: 7
---
...
This topic describes how to uninstall StorageSphere Enterprise 2.0. Uninstallation removes StorageSphere services and packages from the management server and collectors. Depending on your selection, the process can preserve or remove configuration, logs, certificates, and local application data.
