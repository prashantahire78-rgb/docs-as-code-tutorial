...
description: Steps to monitor StorageSphere Enterprise 3.0 system health.
sidebar_position: 3
---
...
This topic describes how to monitor StorageSphere Enterprise 3.0 system health. System health monitoring helps administrators confirm that the management server, database, collectors, discovery jobs, alert processing, reporting services, and integrations are operating normally.
