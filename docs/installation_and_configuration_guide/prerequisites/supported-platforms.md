...
description: Operating systems, hypervisors, and platforms supported by StorageSphere Enterprise 3.0.
sidebar_position: 2
---
...
This topic identifies the operating systems, hypervisors, and directory services that StorageSphere Enterprise 3.0 supports. Verify that your environment uses a supported platform before you install and configure the product.

NovaStor Technologies tests StorageSphere Enterprise 3.0 on the platforms listed in this topic. Platforms not listed might work but are not officially supported.
...
StorageSphere Enterprise 3.0 discovers and monitors storage systems from major vendors through SNMP, REST APIs, and vendor-specific agents. Supported categories include:
