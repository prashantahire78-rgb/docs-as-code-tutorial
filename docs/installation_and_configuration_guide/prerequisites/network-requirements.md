...
description: Network connectivity, DNS, time synchronization, and port requirements for StorageSphere Enterprise 2.0.
sidebar_position: 4
---
...
This topic describes the network connectivity, naming, and time synchronization requirements for StorageSphere Enterprise 2.0. Proper network configuration ensures reliable discovery, metric collection, authentication, and alert delivery across your storage infrastructure.
