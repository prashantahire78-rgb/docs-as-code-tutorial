...
description: Steps to install the StorageSphere Enterprise 3.0 management server.
sidebar_position: 1
---
...
This topic describes how to install the StorageSphere Enterprise 3.0 management server. The management server hosts the web UI, REST API, alert engine, reporting services, RBAC enforcement, and collector registration service.
