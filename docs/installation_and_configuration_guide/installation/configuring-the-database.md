...
description: Steps to configure the StorageSphere Enterprise 3.0 database connection.
sidebar_position: 2
---
...
This topic describes how to configure the database used by StorageSphere Enterprise 3.0. The database stores inventory, configuration, RBAC assignments, alert history, report definitions, and metrics metadata.
...
:::note
PostgreSQL is the recommended database engine for new StorageSphere Enterprise 3.0 deployments unless your organization requires Microsoft SQL Server.
:::
