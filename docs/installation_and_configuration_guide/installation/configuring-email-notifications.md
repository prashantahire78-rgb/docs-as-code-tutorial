...
description: Steps to configure SMTP email notifications for StorageSphere Enterprise 3.0.
sidebar_position: 3
---
...
This topic describes how to configure email notifications for StorageSphere Enterprise 3.0. StorageSphere Enterprise uses email to send alert notifications, report delivery messages, license warnings, and system health notifications through your SMTP relay.
