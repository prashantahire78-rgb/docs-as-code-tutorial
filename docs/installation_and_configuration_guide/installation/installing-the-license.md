...
description: Steps to install and verify a StorageSphere Enterprise 3.0 license.
sidebar_position: 6
---
...
This topic describes how to install a license for StorageSphere Enterprise 3.0. A valid license enables production use of storage discovery, capacity monitoring, performance monitoring, alert management, reporting, RBAC, email notifications, and REST API access.
...
- License file issued by NovaStor Technologies for StorageSphere Enterprise 3.0.
...
| Product and version | License shows StorageSphere Enterprise 3.0 |
...
- Confirm that the license file is for StorageSphere Enterprise 3.0.
