...
description: Steps to run storage discovery jobs in StorageSphere Enterprise 2.0.
sidebar_position: 2
---
...
This topic describes how to discover storage systems in StorageSphere Enterprise 2.0. Discovery connects to configured storage systems, identifies managed resources, collects inventory metadata, and creates monitored objects for capacity and performance collection.
