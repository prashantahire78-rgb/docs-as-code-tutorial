...
description: Steps to troubleshoot missing inventory in StorageSphere Enterprise 3.0.
sidebar_position: 2
---
...
This topic describes how to troubleshoot missing inventory in StorageSphere Enterprise 3.0. Missing inventory can occur when discovery is stale, filters hide resources, collectors are unhealthy, permissions are incomplete, or the storage platform does not expose the expected object.
