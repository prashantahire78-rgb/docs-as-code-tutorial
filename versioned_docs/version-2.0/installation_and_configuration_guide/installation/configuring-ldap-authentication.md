...
description: Steps to configure OpenLDAP authentication for StorageSphere Enterprise 2.0.
sidebar_position: 4
---
...
This topic describes how to configure LDAP authentication for StorageSphere Enterprise 2.0. Use LDAP authentication when your organization manages users and groups in OpenLDAP or another standards-based LDAP directory.
