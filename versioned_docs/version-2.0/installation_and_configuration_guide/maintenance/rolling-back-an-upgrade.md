...
description: Steps to roll back a StorageSphere Enterprise 2.0 upgrade.
sidebar_position: 6
---
...
This topic describes how to roll back a StorageSphere Enterprise 2.0 upgrade. Rollback returns the management server configuration, application packages, and collector versions to the approved previous state when post-upgrade validation fails or a critical issue prevents production use.
