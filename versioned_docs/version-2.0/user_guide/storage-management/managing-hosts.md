...
description: Steps to review hosts and host relationships in StorageSphere Enterprise 2.0.
sidebar_position: 5
---
...
This topic describes how to review hosts in StorageSphere Enterprise 2.0. Host views show servers, clusters, initiators, host groups, mapped volumes, health, and performance relationships.
