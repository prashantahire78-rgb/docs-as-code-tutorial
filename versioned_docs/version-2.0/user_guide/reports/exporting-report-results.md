...
description: Steps to export report results from StorageSphere Enterprise 2.0.
sidebar_position: 3
---
...
This topic describes how to export report results from StorageSphere Enterprise 2.0. Exported reports support operational reviews, capacity planning, incident records, and compliance evidence.
