...
description: Steps to troubleshoot sign-in issues in StorageSphere Enterprise.
sidebar_position: 1
---
...
This topic describes how to troubleshoot sign-in issues in StorageSphere Enterprise. Sign-in failures can result from incorrect provider selection, account lockout, expired passwords, role mapping issues, certificate warnings, or identity provider connectivity.
