...
description: Steps to investigate storage latency issues in StorageSphere Enterprise 2.0.
sidebar_position: 3
---
...
This topic describes how to investigate storage latency issues in StorageSphere Enterprise 2.0. Latency investigation compares affected volumes, hosts, pools, ports, storage systems, alerts, and events to identify likely scope and cause.
