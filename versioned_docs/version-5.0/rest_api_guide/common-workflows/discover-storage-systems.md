...
description: Workflow for automating storage discovery with StorageSphere Enterprise 3.0 REST APIs.
sidebar_position: 1
---
...
This topic describes a common API workflow for automating storage system discovery in StorageSphere Enterprise 3.0. Discovery automation typically validates an existing storage system configuration, starts a discovery job, monitors job status, and verifies discovered resources.
