...
description: Steps to add a storage system connection for discovery in StorageSphere Enterprise.
sidebar_position: 1
---
...
This topic describes how to add a storage system connection in StorageSphere Enterprise. A storage system connection defines the management endpoint, vendor type, credentials, collector assignment, and discovery options used to discover inventory and begin monitoring.
