...
description: Steps to sign in to the StorageSphere Enterprise web UI.
sidebar_position: 1
---
...
This topic describes how to sign in to the StorageSphere Enterprise web UI. StorageSphere Enterprise supports local users and enterprise identity providers, including LDAP and Active Directory.
